...
<head>
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="{{ CustomHelper::appSetting('application_setting','favicon') }}">
                ...
                <ul class="list-inline top-right-nav">
                    <li class="dropdown avtar-dropdown">
                        <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                            <img alt="" class="rounded-circle" src="{{ (\Storage::exists(CustomHelper::currentUser()->image_url)) ? \Storage::url(CustomHelper::currentUser()->image_url) : \URL::to('admin/assets/img/avtar-2.png') }}" width="30">
    ...
    <div class="nano">
        <div class="nano-content sidebar-nav">
            <div class="card-body border-bottom text-center nav-profile">
                <img alt="profile" class="margin-b-10" src="{{ (\Storage::exists(CustomHelper::currentUser()->image_url)) ? \Storage::url(CustomHelper::currentUser()->image_url) : \URL::to('admin/assets/img/avtar-2.png') }}" width="80">
